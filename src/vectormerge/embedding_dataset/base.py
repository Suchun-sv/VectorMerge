...
from vectormerge.reference import BaseSplit
from .single_embedding_dataset import SingleEmbeddingDataset

class EmbeddingDataset(Dataset):
    """Single embedding dataset container for VectorMerge."""
    
    def __init__(self, text_dataset_name: str, source_embedding_model_name: str, target_embedding_model_name: str, align_dimension: bool, dataset_path: str = "./data/raw/beir/", embedding_path: str = "./data/processed/embeddings/", split_config: dict = {}):
        """
        ...
        Args:
            ...
            split_config: Configuration for splitting the dataset. See vectormerge
        """
