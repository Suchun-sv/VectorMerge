"""Wasserstein method adapter for V2 runtime."""
...
class WassersteinMethod(BaseTransformMethod):
    name = "wasserstein"

    def fit(self, context: RunContext) -> Dict[str, Any]:
        reference_key = context.config.get("reference_key")
        reference_method = context.config.get("reference_strategy", "random")
        output = evaluation_pipeline(
            ...
            mapping_method="gromov_wasserstein",
